...
export interface RAGFilters { from: string; to: string; device_id?: string; project_id?: string; logical_project_id?: string; knowledge_scope?: 'project_process'; all_projects?: boolean; activity_type?: ActivityType }
