...
export interface RAGFilters { from?: string; to?: string; device_id?: string; project_id?: string; logical_project_id?: string; knowledge_scope?: 'project_process'; scope_mode?: 'auto' | 'manual'; all_projects?: boolean; activity_type?: ActivityType }
export interface RAGCitation { number: number; document_id: string; fact_id: string; canonical_event_id: string; source_event_ids: string[]; project_id: string; project_name: string; activity_type: ActivityType | 'process_knowledge'; excerpt: string; score: number; occurred_at: string; knowledge_id?: string; chunk_id?: string; source_kind?: string; decision_state?: string; validation_state?: string; applicability?: string; topic?: string }
